...
**Tagline:** *Intelligent Investing. Simplified.*
...
2. **AI-First Analytics** — Every metric scored, ranked, and *explained* in plain language (Hindi/English/Hinglish)
...
*This charter serves as the single source of truth for project scope, goals, and success criteria.*
